...
function deserializePackageJSON(path, contents) {
  ...
  return {
    ...
    get imports() {
      const value = requiresJSONParse(plainImports) ? JSON.parse(plainImports) : plainImports;
      Object.defineProperty(this, 'imports', { __proto__: null, value });
      return this.imports;
    },
    get exports() {
      const value = requiresJSONParse(plainExports) ? JSON.parse(plainExports) : plainExports;
      Object.defineProperty(this, 'exports', { __proto__: null, value });
      return this.exports;
    },
  };
}
