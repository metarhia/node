...
class SourceMapCacheMap {
  ...
  #finalizationRegistry = new FinalizationRegistry(this.#cleanup);
  ...
  set(keys, sourceMapData, moduleInstance) {
    const weakRef = new WeakRef(moduleInstance);
...
Object.freeze(SourceMapCacheMap.prototype);
