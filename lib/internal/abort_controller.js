...
const clearTimeoutRegistry = new FinalizationRegistry(clearTimeout);
...
class AbortSignal extends EventTarget {
  ...
  static any(signals) {
    ...
    resultSignal[kSourceSignals] = new Set();
...
function abortSignal(signal, reason) {
  ...
  const dependentSignalsToAbort = Object.setPrototypeOf([], null);
...
async function aborted(signal, resource) {
  ...
  signal.addEventListener('abort', abortPromiseResolve, opts);
