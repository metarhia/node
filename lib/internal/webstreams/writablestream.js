...
class WritableStream {
  ...
  abort(reason = undefined) {
    if (!isWritableStream(this))
      return Promise.reject(new ERR_INVALID_THIS('WritableStream'));
...
Object.defineProperties(WritableStream.prototype, {
  ...
  [Symbol.toStringTag]: getNonWritablePropertyDescriptor(WritableStream.name),
});

function InternalTransferredWritableStream() {
  Object.setPrototypeOf(this, WritableStream.prototype);
  markTransferMode(this, false, true);
...
Object.setPrototypeOf(InternalTransferredWritableStream.prototype, WritableStream.prototype);
Object.setPrototypeOf(InternalTransferredWritableStream, WritableStream);
...
class WritableStreamDefaultWriter {
  ...
  get closed() {
    if (!isWritableStreamDefaultWriter(this))
      return Promise.reject(new ERR_INVALID_THIS('WritableStreamDefaultWriter'));
...
Object.defineProperties(WritableStreamDefaultWriter.prototype, {
  ...
  [Symbol.toStringTag]: getNonWritablePropertyDescriptor(WritableStreamDefaultWriter.name),
});
...
Object.defineProperties(WritableStreamDefaultController.prototype, {
  ...
  [Symbol.toStringTag]: getNonWritablePropertyDescriptor(WritableStreamDefaultController.name),
});
...
Object.setPrototypeOf(InternalWritableStream.prototype, WritableStream.prototype);
Object.setPrototypeOf(InternalWritableStream, WritableStream);
