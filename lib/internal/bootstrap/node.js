    ...
    set(code) {
      if (code !== null && code !== undefined) {
        ...
        if (typeof code === 'string' && code !== '' &&
          Number.isNaN((value = Number(code)))) {
          value = code;
        }
...
const processConfig = JSON.parse(binding.config, (_key, value) => {
  // The `reviver` argument of the JSON.parse method will visit all the values of
