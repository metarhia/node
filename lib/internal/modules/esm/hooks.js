...
function defineImportAssertionAlias(context) {
  return Object.defineProperty(context, 'importAssertions', {
    __proto__: null,
    configurable: true,
    get() {
    ...
    set(value) {
      emitImportAssertionWarning();
      return Reflect.set(this, 'importAttributes', value);
    },
  });
}
...
Object.setPrototypeOf(Hooks.prototype, null);
...
class HooksProxy {
  ...
  waitForWorker() {
    if (!this.#isReady) {
      ...
      if (!this.#worker[kIsOnline]) {
        ...
        Atomics.wait(this.#lock, WORKER_TO_MAIN_THREAD_NOTIFICATION, 0);
  ...
  async makeAsyncRequest(method, transferList, ...args) {
    ...
    do {
      ...
      await Atomics.waitAsync(this.#lock, WORKER_TO_MAIN_THREAD_NOTIFICATION, this.#workerNotificationLastId).value;
      this.#workerNotificationLastId = Atomics.load(this.#lock, WORKER_TO_MAIN_THREAD_NOTIFICATION);
  ...
  makeSyncRequest(method, transferList, ...args) {
    ...
    do {
      ...
      Atomics.wait(this.#lock, WORKER_TO_MAIN_THREAD_NOTIFICATION, this.#workerNotificationLastId);
      this.#workerNotificationLastId = Atomics.load(this.#lock, WORKER_TO_MAIN_THREAD_NOTIFICATION);
...
Object.setPrototypeOf(HooksProxy.prototype, null);
  ...
  return Object.defineProperty(
    async (arg0 = undefined, context) => {
      ...
      if (context) { // `context` has already been validated, so no fancy check needed.
        Object.assign(meta.context, context);
      }
