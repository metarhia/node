...
async function digest(algorithm, data) {
  ...
  return Reflect.apply(asyncDigest, this, [algorithm, data]);
}
...
async function wrapKey(format, key, wrappingKey, algorithm) {
  ...
  let keyData = await Reflect.apply(exportKey, this, [format, key]);
...
function getRandomValues(array) {
  ...
  return Reflect.apply(_getRandomValues, this, arguments);
}
