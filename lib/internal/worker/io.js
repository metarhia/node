...
const kCurrentlyReceivingPorts =
  Symbol.for('nodejs.internal.kCurrentlyReceivingPorts');
...
const messagePortPrototypePropertyDescriptors = Object.getOwnPropertyDescriptors(MessagePort.prototype);
  ...
  kCreateEvent,
  {
    ...
    value: function(data, type) {
      if (type !== 'message' && type !== 'messageerror') {
        return Reflect.apply(originalCreateEvent, this, arguments);
      }
...
Object.defineProperty(MessagePort.prototype, inspect.custom, {
  ...
  value: function inspect() {  // eslint-disable-line func-name-matching
    ...
    return Object.assign({ __proto__: MessagePort.prototype },
                        ref === undefined ? {
                          active: false,
                        } : {
                          active: true,
...
function setupPortReferencing(port, eventEmitter, eventName) {
  ...
  setOwnProperty(eventEmitter, kNewListener, function(size, type, ...args) {
    ...
    return Reflect.apply(origNewListener, this, arguments);
  });
  ...
  setOwnProperty(eventEmitter, kRemoveListener, function(size, type, ...args) {
    ...
    return Reflect.apply(origRemoveListener, this, arguments);
  });
