...
function InternalTransferredReadableStream() {
  Object.setPrototypeOf(this, ReadableStream.prototype);
  markTransferMode(this, false, true);
...
Object.setPrototypeOf(InternalTransferredReadableStream.prototype, ReadableStream.prototype);
...
Object.defineProperties(ReadableStreamBYOBRequest.prototype, {
  ...
  [Symbol.toStringTag]: getNonWritablePropertyDescriptor(ReadableStreamBYOBRequest.name),
});
...
class ReadableStreamDefaultReader {
  ...
  read() {
    if (!isReadableStreamDefaultReader(this))
      return Promise.reject(new ERR_INVALID_THIS('ReadableStreamDefaultReader'));
  ...
  cancel(reason = undefined) {
    if (!isReadableStreamDefaultReader(this))
      return Promise.reject(new ERR_INVALID_THIS('ReadableStreamDefaultReader'));
    if (this[kState].stream === undefined) {
      return Promise.reject(new ERR_INVALID_STATE.TypeError(
        'The reader is not attached to a stream'));
    }
...
Object.defineProperties(ReadableStreamDefaultReader.prototype, {
  ...
  cancel: kEnumerableProperty,
  [Symbol.toStringTag]: getNonWritablePropertyDescriptor(ReadableStreamDefaultReader.name),
});
...
Object.defineProperties(ReadableStreamBYOBReader.prototype, {
  ...
  releaseLock: kEnumerableProperty,
  cancel: kEnumerableProperty,
  [Symbol.toStringTag]: getNonWritablePropertyDescriptor(ReadableStreamBYOBReader.name),
});
...
Object.defineProperties(ReadableStreamDefaultController.prototype, {
  ...
  [Symbol.toStringTag]: getNonWritablePropertyDescriptor(ReadableStreamDefaultController.name),
});
...
Object.defineProperties(ReadableByteStreamController.prototype, {
  ...
  enqueue: kEnumerableProperty,
  error: kEnumerableProperty,
  [Symbol.toStringTag]: getNonWritablePropertyDescriptor(ReadableByteStreamController.name),
});
...
Object.setPrototypeOf(InternalReadableStream.prototype, ReadableStream.prototype);
...
Object.setPrototypeOf(InternalReadableByteStream.prototype, ReadableStream.prototype);
