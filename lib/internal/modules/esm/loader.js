...
Object.setPrototypeOf(ModuleLoader.prototype, null);
      ...
      if (!emittedLoaderFlagWarning) {
        ...
        process.emitWarning(
          ...
          `--import 'data:text/javascript,import { register } from "node:module"; import { pathToFileURL } from "node:url"; ${ArrayPrototypeJoin(
            ArrayPrototypeMap(userLoaderPaths, (loader) => `register(${readableURIEncode(JSON.stringify(loader))}, pathToFileURL("./"))`),
            '; ',
          )};'`,
          'ExperimentalWarning',
        );
