...
class CallTrackerContext {
  ...
  track(thisArg, args) {
    const argsClone = Object.freeze(ArrayPrototypeSlice(args));
    ArrayPrototypePush(this.#calls, Object.freeze({ thisArg, arguments: argsClone }));
  }
  ...
  getCalls() {
    return Object.freeze(ArrayPrototypeSlice(this.#calls));
  }
