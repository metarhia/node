...
const supportedModules = new Set(new ArrayIterator([
  // '_http_agent',
  // '_http_client',
  // '_http_common',
  // '_http_incoming',
...
function main() {
  ...
  Object.defineProperty(Error, 'stackTraceLimit', initialStackTraceLimitDesc);
  ...
  addAfterUserSerializeCallback(() => {
    ...
    if (desc && (
      ...
      if (desc.configurable) {
        ...
        Object.setPrototypeOf(stackTraceLimitDescToRestore, null);
  ...
  addDeserializeCallback(() => {
    if (stackTraceLimitDescToRestore) {
      Object.defineProperty(Error, 'stackTraceLimit', stackTraceLimitDescToRestore);
    }
  });
